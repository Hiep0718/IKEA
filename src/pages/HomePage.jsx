                    ...
                    <div className="md:flex items-center">
                        <div className="md:w-1/2 mb-6 md:mb-0 md:pr-8">
                            ...
                            <p className="text-gray-700 mb-6">
                                We're committed to creating a better everyday life for people and the planet. From sourcing
                                materials responsibly to designing products that can be recycled, we're working hard to transform
                                our business.
                            </p>
